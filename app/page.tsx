...
function AppInner() {
  ...
  const [bookingCenter, setBookingCenter] = useState<EsportsCenter | null>(null)
  ...
  return (
    <>
      ...
      <main>
        ...
        <CentersMap onBook={setBookingCenter} onMyPC={() => setMyPCOpen(true)} />
      ...
      {/* My PC modal */}
      {myPCOpen && (
        <MyPCModal onClose={() => setMyPCOpen(false)} />
      )}
